...
class AddPublicationToProject extends Component {
  constructor(props) {
    super(props);
    this.state = {
      publicationTypeName: "",
  ...
  submit = () => {
    ...
    let formIsValid = isFormValid(this.state.formdata, "addAdditionalResearchDetails");
            ...
            <form onSubmit={event => this.submit(event)}>
              ...
              <Typography className={classes.title} variant="inherit">
                {this.state.publicationTypeName
                  ? this.state.publicationTypeName + "ນີ້ຢູ່ໃນໂຄງການໃດ?"
                  : "ຜົນງານຄົ້ນຄວ້ານີ້ຢູ່ໃນໂຄງການໃດ?"}
              </Typography>
              <Typography
                variant="inherit"
                style={{ color: "#5f6368", textAlign: "center" }}
              >
                {"ເພີ່ມຜົນງານຄົ້ນຄວ້າຂອງທ່ານໃນໂຄງການ"}
              </Typography>
...
AddPublicationToProject.propTypes = {
...
export default enhance(AddPublicationToProject);
