...
class AddPublicationDetails extends Component {
  ...
  submit = () => {
    ...
    if (
      ...
      this.props.switchPage("additionalDetails");
            ...
            <form>
              ...
              <Grid container style={{ marginTop: 18 }} spacing={16}>
                ...
                <Grid
                  ...
                  xs={12}
                  sm={6}
                  className={classes.publishTypeContainer}
                >
                  <InputLabel
                    htmlFor={this.state.formdata.publicationType.config.name}
                    error={!this.state.formdata.publicationType.valid}
                    style={{ fontSize: 14, fontWeight: 500 }}
                  >
                    {this.state.formdata.publicationType.config.label}
                  </InputLabel>
                  <FormControl
                    fullWidth
                    variant="outlined"
                  ...
                  >
                    <Select
                      error={!this.state.formdata.publicationType.valid}
                      fullWidth
                      value={this.state.formdata.publicationType.value}
                      ...
                      input={
                        <OutlinedInput
                          name={this.state.formdata.publicationType.name}
                          inputProps={{
                            className: classes.selectOutlineInput
                          }}
                        />
                    ...
                    {!this.state.formdata.publicationType.valid ? (
                      <InputError />
                    ) : null}
                  </FormControl>
                  {
