...
class NewcomerResearchersList extends React.Component {
  state = {
    order: "desc",
  ...
  componentWillMount() {
    document.title = "ລາຍງານນັກຄົ້ນຄວ້າຫນ້າໃຫມ່ - FNS Researcher Profiles";
    ...
    this.props
      ...
      .then(response => {
        this.setState({
          data: this.props.user.newResearcherReports
        });
      });
  }
        ...
        >
          ...
          >
            ...
            <Grid item xs={11} sm={11} lg={11} md={11}>
              {this.props.user.newResearcherReports ? (
                <>
                  <EnhancedTableToolbar
                    ...
                    researchersCount={
                      this.props.user.newResearcherReportsCount
                        ? `(${this.props.user.newResearcherReportsCount})`
                        : null
                    }
