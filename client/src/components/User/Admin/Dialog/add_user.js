...
class AddUserDialog extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    // if ((prevProps.user.degrees !== this.props.user.degrees) && (prevProps.user.departments !== this.props.user.departments)) {
      ...
      >
        <DialogTitle style={{ padding: 0 }}>
          <Grid container>
            ...
            >
              <Typography variant="inherit">{`ເພີ່ມນັກຄົ້ນຄວ້າ`}</Typography>
            </Grid>
