...
export const UPDATE_USER_FAX = "update_user_fax";
export const UPDATE_USER_WEBSITE = "update_user_website";
export const UPDATE_USER_GENDER = "update_user_gender";
export const UPDATE_USER_ADDRESS = "update_user_address";
export const UPDATE_USER_FACEBOOK = "update_user_facebook";
export const UPDATE_USER_DATE_OF_BIRTH = "update_user_date_of_birth";
...
export const GET_DEGRESS = "get_degrees";
...
export const GET_NOT_NEW_RESEARCHER = "get_not_new_researcher"
